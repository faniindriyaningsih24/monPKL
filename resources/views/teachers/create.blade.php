                        ...
                        <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>NUTPK</label>
                                        <input type="text" class="form-control" placeholder="NUPTK Guru" name="nuptk">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" class="form-control" placeholder="Nama Guru" name="namaGuru">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control" placeholder="Email Guru" name="email">
                                    </div>
                                    <div class="form-group mb-5">
                                        <label>No HP</label>
                                        <input type="text" class="form-control" placeholder="No.HP Guru" name="noHpGuru">
                                    </div>
