    ...
    <div class="section-body">
        ...
        <table class="table table-bordered" width="100%">
            ...
            <tr>
                ...
                <td>{{ $s->email}}</td>
                <td>{{ $s->noHpGuru}}</td>
                <td><img src="{{ asset("images") }}/{{ $s->photoGuru }}" class="py-2" alt="Foto Siswa" width="100px" height="100px"></td>
                <td><img src="{{ asset("images") }}/{{ $s->parafGuru }}" class="py-2" alt="Paraf Siswa" width="100px" height="100px"></td>
                <td style="width: 13%">
